...
/***/ "./src/modules/UImaniupulation.js":
/*!****************************************!*\
  !*** ./src/modules/UImaniupulation.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "changeActivatedProject": () => (/* binding */ changeActivatedProject),
/* harmony export */   "displayMenu": () => (/* binding */ displayMenu),
/* harmony export */   "displayModal": () => (/* binding */ displayModal),
/* harmony export */   "displayProjectCreation": () => (/* binding */ displayProjectCreation),
/* harmony export */   "displayProjects": () => (/* binding */ displayProjects),
/* harmony export */   "projectTaskCounter": () => (/* binding */ projectTaskCounter),
/* harmony export */   "removeModal": () => (/* binding */ removeModal),
/* harmony export */   "removeProject": () => (/* binding */ removeProject),
/* harmony export */   "removeProjectCreation": () => (/* binding */ removeProjectCreation),
/* harmony export */   "render": () => (/* binding */ render),
/* harmony export */   "taskManipulation": () => (/* binding */ taskManipulation),
/* harmony export */   "updateDefualtTaskCounters": () => (/* binding */ updateDefualtTaskCounters)
/* harmony export */ });
/* harmony import */ var _domCreation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domCreation */ "./src/modules/domCreation.js");
/* harmony import */ var _function__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./function */ "./src/modules/function.js");
/* harmony import */ var _functionBundler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functionBundler */ "./src/modules/functionBundler.js");
...
function displayModal(event) {
    ...
    backgroundModal.appendChild(_domCreation__WEBPACK_IMPORTED_MODULE_0__.createTaskModal(_storage__WEBPACK_IMPORTED_MODULE_3__.masterObject))
    ...
    _function__WEBPACK_IMPORTED_MODULE_1__.addEvent(removeModal, "click", cross, cancelBtn)
    confirmTask.addEventListener("click", _functionBundler__WEBPACK_IMPORTED_MODULE_2__.createTask)
...
function removeModal(event) {
    ...
    _function__WEBPACK_IMPORTED_MODULE_1__.removeEvent(removeModal, "click", cross, cancelBtn)
    confirmTask.removeEventListener("click", _functionBundler__WEBPACK_IMPORTED_MODULE_2__.createTask)

    backgroundModal.removeChild(form)
    backgroundModal.style.display = "none"
}

function displayProjectCreation(event) {
    const projectCreator = _domCreation__WEBPACK_IMPORTED_MODULE_0__.createProjectCreator()
    const projects = document.querySelector(".projects")
    const addProjectBtn = document.querySelector(".addProject")
    const dropdown = document.querySelector(".dropDown")
    dropdown.appendChild(_domCreation__WEBPACK_IMPORTED_MODULE_0__.createProjectCreator())
    //  buttons on modal
    const confirmProjectBtn = document.querySelector(".addProjectBtn")
    const cancelProjectBtn = document.querySelector(".cancelProjectBtn")

    confirmProjectBtn.addEventListener("click", _functionBundler__WEBPACK_IMPORTED_MODULE_2__.createProject)
...
function removeProjectCreation(event) {
    ...
    confirmProjectBtn.removeEventListener("click", _functionBundler__WEBPACK_IMPORTED_MODULE_2__.createProject)
...
function removeProject(event) {
    ...
    const removedProjectIndex = _storage__WEBPACK_IMPORTED_MODULE_3__.masterObject.projects.indexOf(this)

    if (removedProjectIndex != -1) {
        _storage__WEBPACK_IMPORTED_MODULE_3__.masterObject.projects.splice(removedProjectIndex, 1)
        ...
        if (this.title = _storage__WEBPACK_IMPORTED_MODULE_3__.masterObject.currentProject) {
        ...
        // save changes
        _storage__WEBPACK_IMPORTED_MODULE_3__.saveMasterObject()
    }
...
function changeActivatedProject(projectName, element) {
    ...
    _storage__WEBPACK_IMPORTED_MODULE_3__.masterObject.changeCurrentProject(projectName)
    element.closest("li").classList.add("active")
}

function updateDefualtTaskCounters() {
    const taskCounter = this.querySelector(".taskCounter")
    if (this.classList.contains("home")) {
        taskCounter.setAttribute("taskCount", `${_storage__WEBPACK_IMPORTED_MODULE_3__.masterObject.tasks.length}`)
    } else if (this.classList.contains("today")) {
        taskCounter.setAttribute("taskCount", `${_storage__WEBPACK_IMPORTED_MODULE_3__.masterObject.tasks.filter(task => (
            (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(_function__WEBPACK_IMPORTED_MODULE_1__.formatDate2(task.dueDate))))).length}`);
    } else if (this.classList.contains("upcoming")) {
        taskCounter.setAttribute("taskCount", `${_storage__WEBPACK_IMPORTED_MODULE_3__.masterObject.tasks.filter(task => (
            (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(_function__WEBPACK_IMPORTED_MODULE_1__.formatDate2(task.dueDate))))).length}`);
...
function projectTaskCounter(event) {
...
const taskManipulation = (() => {
    ...
    function deleteTask(event) {
        ...
        const taskProject = _storage__WEBPACK_IMPORTED_MODULE_3__.masterObject.projects.find(project =>
    ...
    function editTask(event) {
        ...
        const useableDate = _function__WEBPACK_IMPORTED_MODULE_1__.formatDate(date)

        const taskNameInfo = _function__WEBPACK_IMPORTED_MODULE_1__.checkNameValidity(title)
        ...
        if (this.project != project) {
            const currentProject = _storage__WEBPACK_IMPORTED_MODULE_3__.masterObject.projects.find(theProject => theProject.title == this.project);
            const movingProject = _storage__WEBPACK_IMPORTED_MODULE_3__.masterObject.projects.find(theProject => theProject.title == project)
    ...
    function viewDetails(event) {
        if (backgroundModal.childNodes.length > 0) return
        const detailsELement = _domCreation__WEBPACK_IMPORTED_MODULE_0__.createDetailsModal(
            this.title,
            this.description,
            this.priority,
            this.dueDate,
    ...
    function viewTaskEditor(event) {
        const editElement = _domCreation__WEBPACK_IMPORTED_MODULE_0__.taskEditor(
            _storage__WEBPACK_IMPORTED_MODULE_3__.masterObject,
            this.title,
            this.description,
            this.priority,
            this.dueDate,
...
const render = ((masterObj) => {
    ...
    function todayTasks(event) {
        ...
        masterObj.tasks.forEach(task => {
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(_function__WEBPACK_IMPORTED_MODULE_1__.formatDate2(task.dueDate))))
                tasksContainer.appendChild(taskDomEvent(task));
        })
    }
    ...
    function weekTasks(event) {
        ...
        masterObj.tasks.forEach(task => {
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(_function__WEBPACK_IMPORTED_MODULE_1__.formatDate2(task.dueDate))))
                tasksContainer.appendChild(taskDomEvent(task));
        })
    }
...
/* harmony export */   "masterObject": () => (/* binding */ masterObject),
...
class Project {
    ...
    get projectHTML () {
        return _domCreation__WEBPACK_IMPORTED_MODULE_0__.createProject(this.title)
    }
...
class task {
    ...
    get taskHTML () {
        return _domCreation__WEBPACK_IMPORTED_MODULE_0__.createTask(
            this.title,
            this.priority,
            this.dueDate,
            this.project,
...
/* harmony export */   "createProjectCreator": () => (/* binding */ createProjectCreator),
...
function createTaskModal(masterObj){
    ...
    masterObj.projects.forEach(project => {
        ...
        // default option
        if (project.title == _storage__WEBPACK_IMPORTED_MODULE_0__.masterObject.currentProject) option.selected = true
...
function createTask(title,priority,dueDate,project,completion) {
...
function createDetailsModal(title,details,priority,dueDate,project,completion) {
...
function taskEditor(masterObj,title,description,priority,dueDate,project) {
    ...
    taskEditor.querySelector("#dueDate").value = dueDate=="not due"?
        "":(0,_function__WEBPACK_IMPORTED_MODULE_1__.formatDate2)(dueDate);
...
/* harmony export */   "createFirstTimeMasterObj": () => (/* binding */ createFirstTimeMasterObj),
/* harmony export */   "createProject": () => (/* binding */ createProject),
/* harmony export */   "createTask": () => (/* binding */ createTask),
/* harmony export */   "formatDate": () => (/* binding */ formatDate),
/* harmony export */   "formatDate2": () => (/* binding */ formatDate2),
...
function createFirstTimeMasterObj() {
    // creating master object
    const masterObject = new _classes__WEBPACK_IMPORTED_MODULE_0__.masterObject()
    // adding home project
    masterObject.projects.push(new _classes__WEBPACK_IMPORTED_MODULE_0__.Project("Home"))
    // adding example task
    const exampleTask = new _classes__WEBPACK_IMPORTED_MODULE_0__.task("exampleTask","testing please work", "medium","12/12/12","Home")
...
function addEvent (func,event, ...elements ) {
    elements.forEach(element=>element.addEventListener(event,func))};

function removeEvent (func,event, ...elements ) {
    elements.forEach(element=> element.removeEventListener(event,func))};

function createProject(inputValue){
    const newProject = new _classes__WEBPACK_IMPORTED_MODULE_0__.Project(inputValue)
    //  for expansion if needed
    return newProject
}

function createTask(title,description,priority,dueDate,project) {
    const newTask = new _classes__WEBPACK_IMPORTED_MODULE_0__.task(title,description,priority,dueDate,project)
...
function checkRepeatedProjectName (name) {
    return !!(_storage__WEBPACK_IMPORTED_MODULE_1__.masterObject.projects.find(project =>
        project.title.toLowerCase() == name.toLowerCase()))
}

function formatDate (date) {
    if (!date) return "not due"
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(date), "dd/MM/yy");
}
...
/***/ "./src/modules/functionBundler.js":
/*!****************************************!*\
  !*** ./src/modules/functionBundler.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _UImaniupulation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./UImaniupulation */ "./src/modules/UImaniupulation.js");
...
function createProject(event) {
    ...
    const valueInfo = _function__WEBPACK_IMPORTED_MODULE_1__.checkNameValidity(inputField.value)
    ...
    // project creation
    const newProject = _function__WEBPACK_IMPORTED_MODULE_1__.createProject(inputField.value)
    _storage__WEBPACK_IMPORTED_MODULE_2__.saveProject(newProject,_storage__WEBPACK_IMPORTED_MODULE_2__.masterObject)
    _UImaniupulation__WEBPACK_IMPORTED_MODULE_3__.addProjects(newProject)
    // finishing
    _UImaniupulation__WEBPACK_IMPORTED_MODULE_3__.removeProjectCreation()
...
function createTask(event) {
    ...
    const taskNameInfo = _function__WEBPACK_IMPORTED_MODULE_1__.checkNameValidity(taskNameField.value)
    // const 
    if (!taskNameInfo.validity) {
        const errorMsg = document.querySelector("span.errorMsg")
        errorMsg.textContent = taskNameInfo.message;
    ...
    const useableDate = _function__WEBPACK_IMPORTED_MODULE_1__.formatDate(dueDate.value)
    const newTask = _function__WEBPACK_IMPORTED_MODULE_1__.createTask(
        taskNameField.value,
    ...
    _storage__WEBPACK_IMPORTED_MODULE_2__.saveTask(newTask,_storage__WEBPACK_IMPORTED_MODULE_2__.masterObject)
    _UImaniupulation__WEBPACK_IMPORTED_MODULE_3__.render.updateTasks(newTask)
    _UImaniupulation__WEBPACK_IMPORTED_MODULE_3__.removeModal()
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "masterObject": () => (/* binding */ masterObject),
/* harmony export */   "saveMasterObject": () => (/* binding */ saveMasterObject),
    ...
    if (typeof (Storage) !== "undefined") {
        if (localStorage.masterObject) {
            ...
            if (storedMasterObject.projects[0].title != "Home")
                return (0,_function__WEBPACK_IMPORTED_MODULE_0__.createFirstTimeMasterObj)();

            const newMasterObject = new _classes__WEBPACK_IMPORTED_MODULE_1__.masterObject()
            // transfering all projects and tasks in the projects
            newMasterObject.projects = storedMasterObject.projects.map(project => {
                const newProject = new _classes__WEBPACK_IMPORTED_MODULE_1__.Project()
                newProject.tasks = project.tasks.map(task => {
                    return Object.assign(new _classes__WEBPACK_IMPORTED_MODULE_1__.task(), task);
                });
...
/* harmony import */ var _modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/UImaniupulation */ "./src/modules/UImaniupulation.js");
/* harmony import */ var _modules_function__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/function */ "./src/modules/function.js");
...
const searchBar = document.querySelector("#search")
// event listeners
menuIcon.addEventListener("click" , _modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.displayMenu)
projectsDropdown.addEventListener("click", _modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.displayProjects)
addTaskBtn.addEventListener("click",_modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.displayModal)
addProjectBtn.addEventListener("click",_modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.displayProjectCreation)
// menu buttons
homeBtn.addEventListener("click",_modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.render.homeTasks)
todayBtn.addEventListener("click",_modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.render.todayTasks)
upcomingBtn.addEventListener("click",_modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.render.weekTasks)
completedBtn.addEventListener("click",_modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.render.completedTasks)
allProjects.forEach(project=>
    project.addEventListener("mouseenter",_modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.updateDefualtTaskCounters));
searchBar.addEventListener("keyup",_modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.render.searchedTasks)
searchBar.addEventListener("focusout",e=>{
    searchBar.value=""
    _modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.render.searchedTasks()
})

// window.addEventListener("resize",e =>
//     sideBar.style.height = `${main.scrollHeight}px`)
// other
_modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.addProjects(..._modules_storage__WEBPACK_IMPORTED_MODULE_0__.masterObject.projects)
_modules_UImaniupulation__WEBPACK_IMPORTED_MODULE_1__.render.homeTasks(homeBtn)
// adding task counter 
